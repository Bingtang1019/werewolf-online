...
> 当前版本：**1.4.0**（人机三档决策：挂机/简单/智能——智能带贝叶斯推理、对跳处理、狼队共享；更新公告见 `更新公告.md`）
...
- 人机：三档决策（`bot-brain.js`）——挂机（仅补必要动作/弃票）、简单（关键词嫌疑度，可投被查杀者）、智能（贝叶斯推理：查验/查杀/金水/狼刀死亡/放逐投票为证据，狼人视角可校准预言家可信度并优先刀跳预言家者，多狼 bot 信念共享）；大厅添加人机时按 bot 选择级别，房间 botMode 作为默认级别
