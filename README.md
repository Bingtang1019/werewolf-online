...
> 当前版本：**1.2.0**（首页焕新：双卡入口 / 趣味昵称 / 房间号实时校验 / 创建仪式感 / 在线房间统计；更新公告见 `更新公告.md`）
...
- 首页：双卡入口（创建/加入，加入框常显）、趣味昵称自动生成（🎲 换一个）、房间号实时校验（非法红框抖动 / 6 位合法自动进入）、创建成功「房间号大卡」过渡、在线房间统计（🔥 正在开黑）、首屏夜景（月亮 / 云层 / 狼影呼吸）
